 ...
 * @created 29/03/2017 NZDT
 */
const i=s(4);e.exports=class{constructor(e){return i(this,e||"__call")}static static(e,t){return i(e,t||"__call")}}},function(e,t,s){
/*!
 * Method Missing.
 *
 ...
 * @created 29/03/2017 NZDT
 */
class extends Error{constructor(e){super(e),this.name=this.constructor.name,Error.captureStackTrace(this,this.constructor)}}},function(e,t,s){"use strict";s.r(t);class i{constructor(){this.assets={skierCrash:"img/skier_crash.png",skierLeft:"img/skier_left.png",skierLeftDown:"img/skier_left_down.png",skierDown:"img/skier_down.png",skierRightDown:"img/skier_right_down.png",skierRight:"img/skier_right.png",tree:"img/tree_1.png",treeCluster:"img/tree_cluster.png",rock1:"img/rock_1.png",rock2:"img/rock_2.png"},this.loadedAssets={},this.obstacleTypes=["tree","treeCluster","rock1","rock2"],this.obstacles=[],this.gameWidth=window.innerWidth,this.gameHeight=window.innerHeight,this.canvas=$("<canvas class='canvasTop'></canvas>").attr("width",this.gameWidth*window.devicePixelRatio).attr("height",this.gameHeight*window.devicePixelRatio).css({width:this.gameWidth+"px",height:this.gameHeight+"px"}),$("body").append(this.canvas),this.ctx=this.canvas[0].getContext("2d"),this.skierDirection=5,this.skierMapX=0,this.skierMapY=0,this.skierSpeed=8,this.maxSkierSpeed=16,this.hits=0,this.totalNumberOfHits=3,this.paused=!1}loadAssets(){let e=[];return _.each(this.assets,(t,s)=>{let i=new Image,r=new $.Deferred;i.onload=(()=>{i.width/=2,i.height/=2,this.loadedAssets[s]=i,r.resolve()}),i.src=t,e.push(r.promise())}),$.when.apply($,e)}}class r extends i{moveSkier(){switch(this.skierDirection){case 2:this.skierMapX-=Math.round(this.skierSpeed/1.4142),this.skierMapY+=Math.round(this.skierSpeed/1.4142),this.placeNewObstacle(this.skierDirection);break;case 3:this.skierMapY+=this.skierSpeed,this.placeNewObstacle(this.skierDirection);break;case 4:this.skierMapX+=this.skierSpeed/1.4142,this.skierMapY+=this.skierSpeed/1.4142,this.placeNewObstacle(this.skierDirection)}}getSkierAsset(){let e;switch(this.skierDirection){case 0:e="skierCrash";break;case 1:e="skierLeft";break;case 2:e="skierLeftDown";break;case 3:e="skierDown";break;case 4:e="skierRightDown";break;case 5:e="skierRight"}return e}drawSkier(){let e=this.getSkierAsset(),t=this.loadedAssets[e];if(void 0==t)return;let s=(this.gameWidth-t.width)/2,i=(this.gameHeight-t.height)/2;this.ctx.drawImage(t,s,i,t.width,t.height)}intersectRect(e,t){return!(t.left>e.right||t.right<e.left||t.top>e.bottom||t.bottom<e.top)}checkIfSkierHitObstacle(){let e=this.getSkierAsset(),t=this.loadedAssets[e];if(void 0==t)return;let s={left:this.skierMapX+this.gameWidth/2,right:this.skierMapX+t.width+this.gameWidth/2,top:this.skierMapY+t.height-5+this.gameHeight/2,bottom:this.skierMapY+t.height+this.gameHeight/2};_.find(this.obstacles,e=>{let t=this.loadedAssets[e.type],i={left:e.x,right:e.x+t.width,top:e.y+t.height-5,bottom:e.y+t.height};return this.intersectRect(s,i)})&&(0!=this.skierDirection&&(this.hits+=1),this.skierDirection=0)}setupKeyhandler(){$(window).keydown(e=>{switch(e.which){case 37:1===this.skierDirection?(this.skierMapX-=this.skierSpeed,this.placeNewObstacle(this.skierDirection)):this.skierDirection--,e.preventDefault();break;case 39:5===this.skierDirection?(this.skierMapX+=this.skierSpeed,this.placeNewObstacle(this.skierDirection)):this.skierDirection++,e.preventDefault();break;case 38:1!==this.skierDirection&&5!==this.skierDirection||(this.skierMapY-=this.skierSpeed,this.placeNewObstacle(6)),e.preventDefault();break;case 40:this.skierDirection=3,e.preventDefault();break;case 32:!1===this.paused?this.paused=!0:this.paused=!1,e.preventDefault()}})}drawObstacles(){let e=[];_.each(this.obstacles,t=>{let s=this.loadedAssets[t.type],i=t.x-this.skierMapX-s.width/2,r=t.y-this.skierMapY-s.height/2;i<-100||i>this.gameWidth+50||r<-100||r>this.gameHeight+50||(this.ctx.drawImage(s,i,r,s.width,s.height),e.push(t))}),this.obstacles=e}placeInitialObstacles(){let e=Math.ceil(_.random(5,7)*(this.gameWidth/800)*(this.gameHeight/500)),t=this.gameWidth+50,s=this.gameHeight/2+100,i=this.gameHeight+50;for(let r=0;r<e;r++)this.placeRandomObstacle(-50,t,s,i);this.obstacles=_.sortBy(this.obstacles,e=>{let t=this.loadedAssets[e.type];return e.y+t.height})}placeNewObstacle(e){if(8!==_.random(1,8))return;let t=this.skierMapX,s=this.skierMapX+this.gameWidth,i=this.skierMapY,r=this.skierMapY+this.gameHeight;switch(e){case 1:this.placeRandomObstacle(t-50,t,i,r);break;case 2:this.placeRandomObstacle(t-50,t,i,r),this.placeRandomObstacle(t,s,r,r+50);break;case 3:this.placeRandomObstacle(t,s,r,r+50);break;case 4:this.placeRandomObstacle(s,s+50,i,r),this.placeRandomObstacle(t,s,r,r+50);break;case 5:this.placeRandomObstacle(s,s+50,i,r);break;case 6:this.placeRandomObstacle(t,s,i-50,i)}}placeRandomObstacle(e,t,s,i){let r=_.random(0,this.obstacleTypes.length-1),a=this.calculateOpenPosition(e,t,s,i);this.obstacles.push({type:this.obstacleTypes[r],x:a.x,y:a.y})}calculateOpenPosition(e,t,s,i){let r=_.random(e,t),a=_.random(s,i);return _.find(this.obstacles,e=>r>e.x-50&&r<e.x+50&&a>e.y-50&&a<e.y+50)?this.calculateOpenPosition(e,t,s,i):{x:r,y:a}}clearCanvas(){this.ctx.clearRect(0,0,this.gameWidth,this.gameHeight)}}const a=s(0);class h extends(a(i,r)){updateDashbord(){document.getElementById("distance").innerHTML=Math.ceil(this.skierMapY)+" meters",document.getElementById("speed").innerHTML=this.skierSpeed,document.getElementById("hits").innerHTML=this.hits}checkSpeedHasUpdated(){this.skierMapY>=5e3&&this.updateSpeed()}updateSpeed(){this.skierSpeed<this.maxSkierSpeed&&(this.skierSpeed+=1)}pauseGame(){document.getElementById("pause").innerHTML="<h2>Game Is Paused</h2>",this.skierDirection=0}continueGame(){document.getElementById("pause").innerHTML=""}checkTotalHits(){this.hits===this.totalNumberOfHits&&this.gameOver()}gameOver(){throw $("#over").modal({backdrop:"static",keyboard:!1}),"game over"}}(new class extends h{startGame(){this.initGame()}gameLoop(){!0===this.paused?this.pauseGame():this.continueGame(),this.updateDashbord(),this.checkSpeedHasUpdated(),this.checkTotalHits(),this.ctx.save(),this.ctx.scale(window.devicePixelRatio,window.devicePixelRatio),this.clearCanvas(),this.moveSkier(),this.checkIfSkierHitObstacle(),this.drawSkier(),this.drawObstacles(),this.ctx.restore(),requestAnimationFrame(this.gameLoop.bind(this))}initGame(){this.setupKeyhandler(),this.loadAssets().then(()=>{this.placeInitialObstacles(),requestAnimationFrame(this.gameLoop.bind(this))})}}).startGame()}]);
