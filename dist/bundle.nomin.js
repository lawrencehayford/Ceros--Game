...
const classes = __webpack_require__(3);
const BaseAssets = __webpack_require__(0);
const Controls = __webpack_require__(9);
...
const MethodMissing = __webpack_require__(5);
...
const proxy = __webpack_require__(7);
...
const MethodMissingError = __webpack_require__(8);
...
class Controls extends BaseAssets {
  ...
  placeInitialObstacles() {
    ...
    */
    let numberObstacles = Math.ceil(Math.random(5, 7) * (this.gameWidth / 800) * (this.gameHeight / 500));
